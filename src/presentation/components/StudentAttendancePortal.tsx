        ...
        <div className="max-w-4xl mx-auto p-4 md:p-6 space-y-8 pb-20">
            ...
            <div className="text-center space-y-4 mb-4">
                <div className="animate-in fade-in slide-in-from-top-4 duration-500">
                    <h1 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tighter uppercase">Student Attendance Portal</h1>
                    <p className="text-xs text-slate-500 font-medium italic">Track your attendance progress and official eligibility status</p>
                </div>
