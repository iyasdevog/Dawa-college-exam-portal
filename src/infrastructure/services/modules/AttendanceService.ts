    ...
    public async getAttendanceByClassAndDate(className: string, date: string): Promise<AttendanceRecord[]> {
        try {
            ...
            return Object.entries(periods).map(([subjectId, periodData]: [string, any]) => ({
                ...
                recoveredStudentIds: periodData.recoveredStudentIds || [],
                recoveredReasons: periodData.recoveredReasons || {},
        ...
        try {
            ...
            await updateDoc(docRef, {
                [`periods.${record.subjectId}`]: {
                    ...
                    recoveredStudentIds: record.recoveredStudentIds || [],
                    recoveredReasons: record.recoveredReasons || {},
